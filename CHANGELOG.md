...
- Namespace formatting tests for preset system
...
- Simplified interactive selection merger
- Enforced explicit namespaces for presets (underscore separator internally)
- Renamed `--update` to `--pull` for GitHub preset fetching
- Consolidated and streamlined project documentation
- Updated architecture docs to clarify three-layer system and AGENTS.md role
