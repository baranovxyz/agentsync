...
- Preview and confirmation to import command
- Enhanced tool directory detection in codecs

### Changed

- Design philosophy and CLI-first principles documentation

### Fixed

- Status command error handling
