...
- Never commit secrets. Local configs like `agentsync.local.toml` and `.env` are gitignored and excluded from packages.
...
- Automated checks: typecheck and tests in CI.
